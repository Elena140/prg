class pr003 {
	public static void main(String args[]) throws java.io.IOException {
		...
		for ( int i9=0; i9<3; i9++) {
			System.out.println("Счетчик внешнего уикла: " + i9);
...
stop2:			for(int j9=0; j9<5; j9++) {
		...
		//Использование оператора continue (прерывание текущей интерации)
		System.out.println("\n");
		for(int i9 = 0; i9<=100; i9++) {
			if((i9%2) != 0) continue; //Переход к следующей интерации
