...
class pr004 {
	public static void main(String args[]) {
		...
		Avtomobil lada = new Avtomobil(4, 40, 5.6);
		Avtomobil porshe = new Avtomobil(1, 100, 14,0);
	        int rasst, rasst2;
	
		//Присваивание значений внутренним переменным экземплярам класса
		/*lada.pass = 4;
 		lada.v = 40;
		lada.rash = 5.5;
		...
		*/
		...
		System.out.println("Для расстояния 10 км. нужно" + lada.fuelNeeded(10) + " литров бензина");
		rasst=10;
		System.out.println("Для расстояния 10 км. нужно" + lada.fuelNeeded(rasst) + " литров бензина");
